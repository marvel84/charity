                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img d-none d-lg-block">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/about2.png') }}"
                                    alt="">
                            </div>
                            <div class="about-back-img ">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/about1.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/case1.png') }}"
                                    alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/case2.png') }}"
                                    alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/case3.png') }}"
                                    alt="">
                            </div>
                            <div class="cases-caption">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="#"><img
                                            src="{{ asset('template/charityworks-master/assets/img/gallery/socialEvents1.png') }}"
                                            alt=""></a>
                                </div>
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="#"><img
                                            src="{{ asset('template/charityworks-master/assets/img/gallery/socialEvents2.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="#">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="#"><img
                                            src="{{ asset('template/charityworks-master/assets/img/gallery/socialEvents3.png') }}"
                                            alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="#">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/team1.png') }}"
                                    alt="">
                                <!-- Blog Social -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/team2.png') }}"
                                    alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/team3.png') }}"
                                    alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('template/charityworks-master/assets/img/gallery/team4.png') }}"
                                    alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{ asset('template/charityworks-master/assets/img/gallery/home-blog1.png') }}"
                                        alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{ asset('template/charityworks-master/assets/img/gallery/home-blog2.png') }}"
                                        alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
